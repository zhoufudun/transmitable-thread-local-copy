...
import com.alibaba.ttl.threadpool.DisableInheritableForkJoinWorkerThreadFactory;
...
public class TtlForkJoinPoolHelper {
    ...
    public static ForkJoinWorkerThreadFactory getDisableInheritableForkJoinWorkerThreadFactory(@Nullable ForkJoinWorkerThreadFactory threadFactory) {
        ...
        return new com.alibaba.ttl.threadpool.DisableInheritableForkJoinWorkerThreadFactoryWrapper(threadFactory);
    }
    ...
    public static ForkJoinWorkerThreadFactory unwrap(@Nullable ForkJoinWorkerThreadFactory threadFactory) {
        ...
        return ((com.alibaba.ttl.threadpool.DisableInheritableForkJoinWorkerThreadFactoryWrapper) threadFactory).unwrap();
    }
