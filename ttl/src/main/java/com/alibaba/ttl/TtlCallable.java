 ...
 * @since 0.9.0
 */
public final class TtlCallable<V> implements Callable<V>, com.alibaba.ttl.TtlEnhanced {
     ...
     *
     * @param callable                          input {@link Callable}
     * @param releaseTtlValueReferenceAfterCall release TTL value reference after run, avoid memory leak even if {@link com.alibaba.ttl.TtlRunnable} is referred.
     * @return Wrapped {@link Callable}
     */
    @Nullable
